...
export const useCloudinaryUpload = () => {
  ...
  const uploadToCloudinary = async (file: UploadToCloudinaryParams): Promise<{ success: boolean }> => {
    ...
    try {
      const response = await postMultipartFormData(COMMON_ENDPOINTS.UPLOAD_TO_CLOUDINARY, formData);
